...
/**
 * Create by Alex Chan in 20:36  2017/11/2
 */
...
public final class StdRandom {
    ...
    private static Random random;    // 随机数对象pseudo-random number generator
    private static long seed;        // 用于产生随机数的种子pseudo-random number generator seed
